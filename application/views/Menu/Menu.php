        ...
        <div class="row justify-content-center mt-5">
            ...
            <div class="col-md-6">
                <div class="card" onmouseover="growCard(this)" onmouseout="shrinkCards()">
                    <div class="card-body text-center">
                        ...
                        <h5 class="card-title mt-2">Promoción por producto</h5>
            ...
            <div class="col-md-6">
                <div class="card" onmouseover="growCard(this)" onmouseout="shrinkCards()">
                    <div class="card-body text-center">
                        <!-- SVG para el icono de promoción -->
                        <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="200" height="200">
                            ...
                            <path d="M16,10.5A3.5,3.5,0,1,0,12.5,7,3.5,3.5,0,0,0,16,10.5Zm0-5A1.5,1.5,0,1,1,14.5,7,1.5,1.5,0,0,1,16,5.5Z"/></svg>

                        <h5 class="card-title mt-2">Promoción por imagen</h5>
                        <?php if ($configuracion['promocion_act'] === 't') { ?>
                            <a href="<?php echo base_url() ?>ControladorPromocionPorImagen/index" class="stretched-link"></a>
                        <?php } else { ?>
                            <a href="#" class="stretched-link" onclick="openModal(); return false;"></a>
                        <?php } ?>
                    </div>
            ...
            <div class="col-md-6"> <!-- Nuevo card para cerrar sesión -->
                <div class="card" onmouseover="growCard(this)" onmouseout="shrinkCards()">
                    <div class="card-body text-center">
